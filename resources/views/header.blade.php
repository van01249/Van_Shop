<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 237 Lĩnh Nam, Hoàng Mai, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0396646090 </a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
					@if(Auth::check())
						<li><a href="{{route('history')}}">Lịch sử đơn hàng</a></li>
						<li><a href="profile">Chào bạn {{Auth::user()->full_name}}</a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="./" id="logo"><img src="source/image/logo.png" width="200px" alt=""></a>
				</div>
						...
						<div class="cart">
							...
							@foreach($product_cart as $product)
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="{{route('chitietsanpham',$product['item']['id'])}}"><img src="upload/sanpham/{{$product['item']['image']}}" alt=""></a>
		...
		<div class="header-bottom" style="background-color: #9A2EFE;">
			<div class="container">
